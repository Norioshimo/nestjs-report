...
export const getEmploymentLetterByIdReport = (
  ...
  const docDefinition: TDocumentDefinitions = {
    ...
    content: [
      ...
      {
        text: `Yo, ${employeeName}, en mi calidad de ${employerPosition} de ${employerCompany},
        por medio de la presente certifco que ${employerCompany} ha sido empleado en nuestra
        empresa desde el ${DateFormatter.getDDMMMMYYYY(employeeStartDate)}. \n\n
        Durante su empleo, el Sr./Sra. ${employerName} ha desempeñado el cargo de${employeePosition}, 
        demostrando responsabilidad, compromiso y habilidades profesionales en sus
        labores. \n\n
        La jornada laboral del Sr./ Sra. ${employerCompany} es de ${employeeHours} horas
